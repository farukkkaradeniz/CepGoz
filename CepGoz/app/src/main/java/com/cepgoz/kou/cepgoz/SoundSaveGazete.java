...
public class SoundSaveGazete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_save_gazete);
        if(ContextCompat.checkSelfPermission(getApplicationContext(),
                Manifest.permission.RECORD_AUDIO)!= PackageManager.PERMISSION_GRANTED){
            if(ActivityCompat.shouldShowRequestPermissionRationale(SoundSaveGazete.this,
                    Manifest.permission.RECORD_AUDIO)){
            }else{
                ActivityCompat.requestPermissions(SoundSaveGazete.this,
                        new String[]{Manifest.permission.RECORD_AUDIO},PERMISSION_GROUP);
            }
        }
        izinler();
        mic=(ImageView)findViewById(R.id.imageViewSoundSaveGazeteStartRecorder);
        stop=(ImageView)findViewById(R.id.imageViewSoundSaveGazeteStopRecorder);
        upload=(ImageView)findViewById(R.id.imageViewSoundSaveGazeteUploadRecord);
        stop.setVisibility(View.INVISIBLE);
        upload.setVisibility(View.INVISIBLE);
        edtBookName=(EditText)findViewById(R.id.edtSoundSaveGazeteBookName);
        edtWriterName=(EditText)findViewById(R.id.edtSoundSaveGazeteWriterName);
            ...
            Thread mythread = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        WebServiceBook.insertNewGazete(edtBookName.getText().toString(), link);
                    } catch (Exception e) {
                        e.printStackTrace();
                        try {
